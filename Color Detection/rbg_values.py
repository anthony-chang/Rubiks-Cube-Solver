...
def rgb(event, x, y, flags, param):
    if event == cv2.EVENT_MOUSEMOVE:  # checks mouse moves
        ...
        cv2.rectangle(image, (0, 0), (120, 30), (255, 255, 255), -1)
        cv2.putText(image, str(colorsRGB), (10, 20), cv2.FONT_HERSHEY_PLAIN, 0.9, 0)
...
cv2.namedWindow('thing', cv2.WINDOW_AUTOSIZE)
