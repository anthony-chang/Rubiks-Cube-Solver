...
class PackageFinder(object):
    ...
    def find_all_candidates(self, project_name):
        ...
        search = lib.Search(project_name, canonical_name, formats)
    ...
    def _link_package_versions(self, link, search):
        # type: (Link, lib.Search) -> Optional[InstallationCandidate]
...
lib.Search = namedtuple('lib.Search', 'supplied canonical formats')
